"""
Mirroring Example using YAW.

This script demonstrates the capability to mirror messages using the MiddlewareCommunicator within the YAW library.
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Mirroring Example using YAW.")
    parser.add_argument(
