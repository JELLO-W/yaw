"""
Forwarding Example using YAW.

This script demonstrates message forwarding using the MiddlewareCommunicator within the YAW library.
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Forwarding Example using YAW.")
    parser.add_argument(
