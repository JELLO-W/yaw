"""
Channeling Example using YAW.

This script demonstrates message channeling through three different middleware (A, B, and C) using
the MiddlewareCommunicator within the YAW library. It allows message publishing and listening
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Channeling Example using YAW.")
    parser.add_argument(
