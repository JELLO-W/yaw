...
the MiddlewareCommunicator within the YAW library. The communication follows the REQ/REP pattern
...
Requirements:
    ...
    - OpenCV: Used for handling and creating images (installed with YAW)
...
class ReqRep(MiddlewareCommunicator):
    ...
    def send_img_message(self, msg=None, img_width=320, img_height=240,
        ...
        img = cv2.imread("../../resources/yaw.png")
