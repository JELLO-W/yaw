...
``YAW_PLUGINS_PATH`` environment variable to include the current directory, which contains the
...
# Modifying the YAW_PLUGINS_PATH environment variable to include the plugins directory
script_dir = os.path.dirname(os.path.realpath(__file__))
if 'YAW_PLUGINS_PATH' in os.environ:
    os.environ['YAW_PLUGINS_PATH'] += os.pathsep + script_dir
else:
    os.environ['YAW_PLUGINS_PATH'] = script_dir
