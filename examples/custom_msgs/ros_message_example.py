"""
A message publisher and listener for ROS messages using YAW.
...
the YAW library. The communication follows the PUB/SUB pattern allowing
...
Requirements:
    ...
    - ROS, ROSPy: Used for handling and creating ROS messages (refer to the YAW documentation for installation instructions)
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="A message publisher and listener for ROS messages using YAW.")
    parser.add_argument(
