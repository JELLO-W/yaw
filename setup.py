...
setuptools.setup(
    ...
    url              = 'https://github.com/JELLO-W/yaw/blob/master/',
    project_urls={
        'Documentation': 'https://yaw.readthedocs.io/en/latest/',
        'Source':        'https://github.com/JELLO-W/yaw/',
        'Tracker':       'https://github.com/JELLO-W/yaw/issues',
    },
    author           = 'JELLO-W',
    author_email     = 'yaw@jello-w.nolink',
    maintainer       = 'JELLO-W',
    maintainer_email = 'yaw@jello-w.nolink',
