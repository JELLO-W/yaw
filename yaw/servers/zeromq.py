...
from yaw.middlewares.zeromq import ZeroMQMiddlewareReqRep
from yaw.encoders import JsonEncoder, JsonDecodeHook


SOCKET_IP = os.environ.get("YAW_ZEROMQ_SOCKET_IP", "127.0.0.1")
SOCKET_PUB_PORT = int(os.environ.get("YAW_ZEROMQ_SOCKET_REQ_PORT", 5558))
SOCKET_SUB_PORT = int(os.environ.get("YAW_ZEROMQ_SOCKET_REP_PORT", 5559))
