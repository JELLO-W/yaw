...
class JsonEncoder(json.JSONEncoder):
    ...
    def encode(self, obj):
        ...
        def hint_tuples(item):
            if isinstance(item, tuple):
                return dict(__yaw__=('tuple', item))
    ...
    def default(self, obj):
        ...
        if isinstance(obj, set):
            ...
            return dict(__yaw__=('datetime', obj.isoformat()))

        elif isinstance(obj, np.datetime64):
            return dict(__yaw__=('numpy.datetime64', str(obj)))
        ...
        if isinstance(obj, dict):
            ...
            if yaw is not None:
                ...
                if obj_type == 'tuple':
                    ...
                    return datetime.fromisoformat(yaw[1])

                elif obj_type == 'numpy.datetime64':
                    return np.datetime64(yaw[1])
