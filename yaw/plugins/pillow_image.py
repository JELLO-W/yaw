"""
Encoder and Decoder for PIL Image Data via YAW.

This script provides mechanisms to encode and decode PIL Image data using YAW.
    ...
    def encode(self, obj, *args, **kwargs):
        ...
        :return: Tuple[bool, dict]: A tuple containing:
            ...
            - dict: A dictionary containing:
                - '__yaw__': A tuple containing the class name and encoded data string, with optional image size and mode for raw data
        """
        if obj.format is None:
            obj_data = base64.b64encode(obj.tobytes()).decode('ascii')
            return True, dict(__yaw__=(str(self.__class__.__name__), obj_data, obj.size, obj.mode))
        else:
