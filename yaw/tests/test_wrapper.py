...
class ZeroMQTestWrapper(unittest.TestCase):
    ...
    def test_activate_communication(self):
        ...
        called, the ``__YAW_INSTANCES`` attribute of the decorated function should be updated with the instance of
        ...
        """
        import yaw.tests.tools.class_test as class_test
    ...
    def test_close(self):
        ...
        in the ``__YAW_INSTANCES`` attribute of the decorated function. Destroying the class instance should remove the
        ...
        test_id = Test._MiddlewareCommunicator__registry["Test.exchange_object"]["__YAW_INSTANCES"].index(hex(id(test)))
        test3_id = Test._MiddlewareCommunicator__registry["Test.exchange_object"]["__YAW_INSTANCES"].index(hex(id(test3)))
